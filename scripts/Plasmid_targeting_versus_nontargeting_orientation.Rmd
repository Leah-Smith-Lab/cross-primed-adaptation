...
```{r}
  ...
  # Define a function to process the data frame by feature
...
## Plot CRISPR3/CRISPR4 targeting vs non-targeting orientation 
```{r}
...
## Collapse counts to plot combined CRISPR3 / CRISPR4 targeting summary
```{r}
  ...
  collapse_plasmid_data <- function(df) {
    df %>%
      ...
      # Calculate proportions and differences from random (0.5)
      mutate(
      ...
      # Ungroup the data to return a clean dataframe
      ungroup()
  }
  
  # Apply the function to collapse arrays
...
## Plot reduction in targeting spacers (expected-observed)
```{r}
  #WT
