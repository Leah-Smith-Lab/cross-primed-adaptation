...
# Read in mapping summary data and filter for plotting
  # Mapping statistics were extracted from individual BAM files using samtools then concatenated in an Excel file
...
```{r}
# Read in summary data from CRISPRdetect / CRISPRtarget output
